...
class _SuccessPageState extends State<SuccessPage> {
  ...
  void pageSpeech() {
    textToSpeech(
        'Congratulations! You finish the game, share the code with your friend. The code is ${gameObj.code}');
  }
